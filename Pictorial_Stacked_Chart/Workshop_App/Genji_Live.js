(function () {
  ...
  kintone.events.on('app.record.index.show', function (event) {
    ...
    function charting(svgData, type) {
      ...
      // Following are default field codes:
      // Fruit = Drop_down; Programming language = Drop_down_0; Caffeine = Drop_down_1; Web browser = Drop_down_2; Nationality = Drop_down_3
      var kData = event.records.reduce(function (result, current) {
    ...
    svgButton.innerText = 'Change Graph';
    svgButton.onclick = changingGraphs;
    svgButton.style = styling;

    var pointer = 0;
    var svgArray = [svgApple, svgTerminal, svgCoffee, svgBrowser, svgHuman];
  ...
  // svgHuman, svgBottle, svgCan, svgApple
...
// https://drive.google.com/uc?export=view&id=1C2cObu41erwg5G9oI8c2BNVEoP6o24X1